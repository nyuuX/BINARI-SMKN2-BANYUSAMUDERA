...
export default function Pkldata() {
    ...
    function getUsers() {
        ...
        axios.get('http://localhost:80/binari/pkl/users').then(function(responses) {
    ...
    return (
        ...
        <Adminnav/>
            <h1 className="text-center text-2xl mb-20">LIST DATA PKL</h1>
